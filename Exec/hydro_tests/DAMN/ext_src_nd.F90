  ...
  subroutine ca_ext_src(lo,hi,&
                        ...
                        src,src_lo,src_hi,problo,dx,time,dt,xlo)
    ...
    real(rt)         :: problo(3),dx(3),time,dt,xlo(3)
    ...
    do i = lo(1), hi(1)
        ...
        src(i,lo(2):hi(2),lo(3):hi(3),URHO) = -new_state(i,lo(2):hi(2),lo(3):hi(3),UMX) / xx

        src(i,lo(2):hi(2),lo(3):hi(3),UMX) = -new_state(i,lo(2):hi(2),lo(3):hi(3),UMX)*new_state(i,lo(2):hi(2),lo(3):hi(3),UMX) / (xx * new_state(i,lo(2):hi(2),lo(3):hi(3),URHO))
